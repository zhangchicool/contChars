...
2. pterosaurs (data, commands, and log files) 
    ...
    2. data_norm.nex: both continuous (normalized) and discrete characters.
    3. data_log_nm.nex: continuous (log-transformed and normalized) and discrete characters.
...
4. test (runs for a ten-taxa dataset comparing MrBayes and RevBayes)
